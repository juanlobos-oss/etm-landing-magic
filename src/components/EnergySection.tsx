        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          ...
          <motion.div
            ...
            <div className="border border-primary/30 bg-primary/5 p-5 rounded-md">
              <p className="text-primary italic text-base font-light font-sans">El espacio más valorado para hacer networking en todo el evento fueron los stands de emprendedores.
...
Global Metrics. (2025). Encuesta de satisfacción digital EtMday.
        ...
        <div className="grid md:grid-cols-3 etm-grid">
          {testimonials.map((t, i) => <motion.div key={i} className="etm-grid-item"
          initial={{ opacity: 0, y: 10 }}
          whileInView={{ opacity: 1, y: 0 }}
